...
export const description = "Bitwise operators in sCrypt"
export const replitLink = ""

const html = `<p>TypeScript&#39;s bitwise operator cannot be used in sCrypt. But you can use the <a href="https://scrypt.io/scrypt-ts/getting-started/how-to-write-a-contract/#bitwise-operators">bitwise built-in functions</a> provided by sCrypt.</p>
