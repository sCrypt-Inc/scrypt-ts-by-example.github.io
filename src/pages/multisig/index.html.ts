...
<pre><code class="language-ts"><span class="hljs-keyword">class</span> <span class="hljs-title class_">MultiSigPayment</span> <span class="hljs-keyword">extends</span> <span class="hljs-title class_ inherited__">SmartContract</span> {
  ...
  <span class="hljs-keyword">public</span> <span class="hljs-title function_">unlock</span>(<span class="hljs-params">
      signatures: FixedArray&lt;Sig, <span class="hljs-number">3</span>&gt;, 
      publicKeys: FixedArray&lt;PubKey, <span class="hljs-number">3</span>&gt;
    </span>) {
