...
<pre><code class="language-ts"><span class="hljs-keyword">let</span> pubKey = <span class="hljs-title class_">PubKey</span>(<span class="hljs-title function_">toByteString</span>(<span class="hljs-string">&#x27;02a2ef6eb12d3076dbdc98241920f75ac88b664656400aa390a0b236ea1eb6ec0b&#x27;</span>))
