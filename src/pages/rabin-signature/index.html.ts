...
<span class="hljs-keyword">class</span> <span class="hljs-title class_">RabinVerifier</span> <span class="hljs-keyword">extends</span> <span class="hljs-title class_ inherited__">SmartContractLib</span> {
    ...
    <span class="hljs-meta">@method</span>()
    <span class="hljs-keyword">static</span> <span class="hljs-title function_">verifySig</span>(
        <span class="hljs-attr">msg</span>: <span class="hljs-title class_">ByteString</span>,
        <span class="hljs-attr">sig</span>: <span class="hljs-title class_">RabinSig</span>,
        <span class="hljs-attr">pubKey</span>: <span class="hljs-title class_">RabinPubKey</span>
