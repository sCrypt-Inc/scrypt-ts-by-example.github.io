...
<pre><code class="language-ts"><span class="hljs-keyword">class</span> <span class="hljs-title class_">RabinSignature</span> <span class="hljs-keyword">extends</span> <span class="hljs-title class_ inherited__">SmartContract</span> {
  ...
  <span class="hljs-meta">@method</span>()
  <span class="hljs-keyword">public</span> <span class="hljs-title function_">verifySig</span>(<span class="hljs-params">sig: <span class="hljs-built_in">bigint</span>,
                   msg: <span class="hljs-built_in">string</span>, padding: <span class="hljs-built_in">string</span>,
                   n: <span class="hljs-built_in">bigint</span></span>) {
